...
<body class="bg-light">
  ...
  <!--carousel-->
<div class="container-flid px-lg-4 mt-4">
  ...
  <div class="swiper swiper-testimonials">
    <div class="swiper-wrapper mb-5">
      ...
      <div class="swiper-slide bg-white p-4">
        ...
        <p>
Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam, odio deserunt repellendus facilis laudantium eos obcaecati voluptate fuga sint corporis.
...
<h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">RAECH US</h2>
<div class="container">
  <div class="row">
...
<div class="bg-white p-4 rounded mb-4">
  <h5>Call Us</h5>
  <a href="mob: +<?php echo $contact_r['pn1'] ?>" class="d-inline-block mb-2 text-decoration-none text-dark">
  ...
  if($contact_r['pn2']!=''){
    echo<<<data
          <a href="mob: +$contact_r[pn2]" class="d-inline-block text-decoration-none text-dark">
